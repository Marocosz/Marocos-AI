...
1. **Agentes de IA que produzem trabalho, não conversa.** Chatbot é o formato mais fácil e quase nunca o mais útil, e a maior parte dos meus agentes não fala com ninguém. Eles escrevem a consulta SQL que o analista não sabia escrever, montam documento de qualidade com aprovação humana no meio, agrupam mil chamados de suporte e explicam o padrão, emitem sugestão tipada que o frontend renderiza como card e botão, ou escrevem um relatório de segurança num agendador sem ninguém pedir. Para isso a saída tem de ser válida para uma MÁQUINA, e não só legível para uma pessoa — é o que exige contrato tipado, validação estrita e normalização da saída solta do modelo. Onde a decisão é séria existe porta de aprovação humana; onde o modelo não sabe, uma guarda faz ele dizer que não sabe em vez de inventar. Por baixo disso: grafo de estados em código determinístico (não swarm), roteador barato antes do modelo caro, recuperação sobre base vetorial, guarda de responsabilidade, agente corretor que devolve o erro do banco ao modelo, e guarda de SQL por árvore sintática antes de qualquer coisa tocar produção. Conversacional é UM dos formatos, e onde ele aparece — o motor de cobrança da Finza e o Marcos Virtual — cada conversa é instrumentada, porque agente que ninguém mede é boato. Sustentam isso: o Hub de Agentes da Supporte (text-to-SQL, Scope Intelligence, doc-qualidade, doc-robos), a Bússola V2 com 18 agentes em cinco domínios, o Portal de Controle de Acesso, o motor de cobrança na Finza, e o próprio Marcos Virtual.
